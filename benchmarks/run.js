import { astarBench } from './astar.bench.js';
import { dfsBench } from './dfs.bench.js';
import { bfsBench } from './bfs.bench.js';
...
function testPerformanceRecursive(size) {
    ...
    for (let i = 0; i < nbIterations; i++) {
        ...
        for (const nameAlgo of algo) {
            ...
            switch (nameAlgo) {
                case "AStar" :
                    nbNodesExplored = astarBench(maze);
